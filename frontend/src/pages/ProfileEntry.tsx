...
import { getProfileRouteForRole } from '../api/role.api';

/**
 * Entry point for profile at /profile
 * Fetches user role and redirects to appropriate profile page based on role level
 */
const ProfileEntry: React.FC = () => {
    ...
    // Redirect to appropriate profile page based on role level
    const targetRoute = getProfileRouteForRole(roleLevel);
